...
import nehad from "../Images/nehad.jpeg";
  ...
  return (
    <div>
      ...
      <div className={style.about}>
        ...
        <div className={style.text}>
          <h3 className={style.h3text}>
            We build the best Furniture <br /> for your comfort and choice
          </h3>
          <p>
      ...
      <div className={style.slider}>
        <h1 className="text-center m-5" style={{ color: "rgb(18, 77, 145)" }}>
